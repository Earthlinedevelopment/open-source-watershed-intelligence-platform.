...
function patchBody(body,variant){
  ...
  r('terrainCounterDecl','    const promise=(async()=>{\n      const primary=TERRARIUM.replace(\'{z}\',z).replace(\'{x}\',x).replace(\'{y}\',y);','    window.EARTHLINE_TERRAIN_RACE_16594=window.EARTHLINE_TERRAIN_RACE_16594||{primaryStarted:0,alternateStarted:0};\n    const promise=(async()=>{\n      const primary=TERRARIUM.replace(\'{z}\',z).replace(\'{x}\',x).replace(\'{y}\',y);');
