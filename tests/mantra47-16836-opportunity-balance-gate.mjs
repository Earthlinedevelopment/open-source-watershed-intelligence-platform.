...
for(const state of STATES){
  ...
  const gate=!!audit&&!loadError&&!timedOut&&pageErrors.length===0&&audit.generated===audit.visible&&audit.unsafe===0&&containmentOK&&Number(audit.coreMs)<=15000&&arSpatialOK;
