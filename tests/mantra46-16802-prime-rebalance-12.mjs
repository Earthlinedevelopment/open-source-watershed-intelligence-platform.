...
const OUT='artifacts/mantra46-16802-prime-rebalance-12';
mkdirSync(OUT,{recursive:true});

const BASELINE={
  Iowa:{candidatePrime:0,selectedPrime:0},
  Arkansas:{candidatePrime:208,selectedPrime:179,targetSelected:false},
  Oklahoma:{candidatePrime:209,selectedPrime:196},
  Nebraska:{candidatePrime:0,selectedPrime:0},
  Vermont:{candidatePrime:0,selectedPrime:0},
  Texas:{candidatePrime:0,selectedPrime:0},
  Florida:{candidatePrime:44,selectedPrime:42},
  Louisiana:{candidatePrime:0,selectedPrime:0},
  California:{candidatePrime:0,selectedPrime:0},
  'New York':{candidatePrime:0,selectedPrime:0},
