...
const CASES=['Louisiana','Maryland','New Jersey','North Carolina','South Carolina','Tennessee'];
mkdirSync('artifacts/mantra46-16790-coastal',{recursive:true});
...
for(const query of CASES){
  ...
  results.push(row);
  console.log('EARTHLINE_M46_16790_GATE_AUDIT '+JSON.stringify(row));
  await context.close();
}
await browser.close();
writeFileSync('artifacts/mantra46-16790-coastal/gate-audit.json',JSON.stringify(results,null,2));
