...
mkdirSync('artifacts/mantra46-16791-ia-ar-visual',{recursive:true});
...
for(const query of CASES){
  ...
  try{await page.screenshot({path:'artifacts/mantra46-16791-ia-ar-visual/'+query.toLowerCase()+'.png',fullPage:false});}catch(_){}
...
await browser.close();
writeFileSync('artifacts/mantra46-16791-ia-ar-visual/results.json',JSON.stringify(rows,null,2));
