...
for(let repeat=1;repeat<=3;repeat++){
  ...
  out.push(row);console.log('EARTHLINE_TX_SINGLEPASS '+JSON.stringify(row));await page.close();
}
console.log('EARTHLINE_TX_SINGLEPASS_SUMMARY '+JSON.stringify(out));
await browser.close();
