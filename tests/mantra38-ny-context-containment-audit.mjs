...
await page.waitForFunction(()=>window.EARTHLINE_REGIONAL_ATOMIC_PREFLIGHT_16329?.passed===true,null,{timeout:30000,polling:150});
try{await page.waitForFunction(()=>!!window.EARTHLINE_OPTIONAL_CONTEXT_CONTAINMENT_16565,null,{timeout:12000,polling:150});}catch(_){ }
