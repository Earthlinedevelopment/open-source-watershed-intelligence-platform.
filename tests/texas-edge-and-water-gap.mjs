 ...
 const repl=`    const gapAttempts16621=[];
    ...
    if(coarseGapPass16621&&gapAttempts16621.length){
      ...
      for(const attempt16621 of gapAttempts16621){
        ...
        if(edgeDistance16625>8)continue;
    ...
    function nearInvalidWater16626(g16626){
      ...
      for(let dy16626=-2;dy16626<=2;dy16626++)for(let dx16626=-2;dx16626<=2;dx16626++){
    ...
    window.EARTHLINE_WATER_EDGE_FALLBACK_16626={enabled:coarseGapPass16621&&!!(hy&&hy.validityMask16584),evaluated:waterEdgeEvaluated16626,added:waterEdgeAdded16626,radiusCells:2};
        window.EARTHLINE_GAP_FALLBACK_16621={enabled:coarseGapPass16621,attempts:gapAttempts16621.length,added:gapAdded16621,edgeOnly:true,edgeCells:8};`;
