...
const prepared=await frame.evaluate(async target=>{
  if(typeof window.earthlineSelectedSiteFromCenter!=='function'||typeof window.applyLocation!=='function'||typeof window.earthlineSetPropertyTarget16201!=='function')return {ok:false,reason:'authoritative fixed-site preparation API unavailable'};
