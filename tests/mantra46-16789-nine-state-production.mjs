...
const STATES=['Louisiana','Maryland','Mississippi','New Hampshire','New Jersey','New Mexico','North Carolina','South Carolina','Tennessee'];
...
mkdirSync('artifacts/mantra46-16789-nine',{recursive:true});
...
for(const query of STATES){
  ...
  if(VISUAL.has(query)){
    ...
    try{await page.screenshot({path:`artifacts/mantra46-16788-50state/${slug}.png`,fullPage:false});}catch(_){}
  }
...
writeFileSync('artifacts/mantra46-16788-50state/results.json',JSON.stringify({summary,results},null,2));
