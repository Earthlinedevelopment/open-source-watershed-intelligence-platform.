...
async function runQuery(frame,query,kind){
  ...
  const performancePass=elapsedMs<=HARD_CEILING_MS,terminalPass=!timedOut&&identity&&after.runBusy===false&&!(after.regional&&after.regional.active),uiPass=!after.diagnosticVisible;
